...
class PaymentCard(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # Link the payment card to a user
    card_number = models.CharField(max_length=12, unique=True)  # Ensure the card number is unique
